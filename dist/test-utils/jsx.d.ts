 ...
 */
export declare const jsx: <S extends "text" | "element" | "editor" | "focus" | "anchor" | "cursor" | "fragment" | "selection">(tagName: S, attributes?: Object | undefined, ...children: any[]) => ReturnType<({
